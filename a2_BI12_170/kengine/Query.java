...
/**
 * A method to return an Iterator of the query matches or null if no matches.
 * @effects returns an Iterator of the query matches or null if no matches. You will need this method to generate the HTML search report.
 * @return
 */
public Iterator<DocCnt> matchIterator() {
  //returns an Iterator of the query matches or null if no matches. You will need this method to generate the HTML search report.
